...
namespace CapaVistaFRM
{
    ...
    {
        string usuario = "";        
        public mantenimiento_cliente(String usuarioActivo)
        {
            InitializeComponent();
            usuario = usuarioActivo;
            string[] alias = { "Membresia", "DPI", "Nombres", "Apellidos", "Fecha Nac.", "Direccion", "Teléfono", "Correo", "Sexo", "Estado" }; // Arreglo de nombres para campos
            ...
            navegador1.asignarNombreForm("CLIENTE"); // Titulo y nombre del form
        }
