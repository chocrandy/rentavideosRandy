...
{
    public partial class mantenimiento_mora : Form
    {
        string usuario = "";        
        public mantenimiento_mora(String usuarioActivo)
        {
            InitializeComponent();
            usuario = usuarioActivo;
            string[] alias = { "Cod. Mora", "Membresia", "Monto", "Fecha", "Estado"}; // Arreglo de nombres para campos
            ...
            navegador1.asignarTabla("MORA"); // tabla principal
            navegador1.asignarNombreForm("MORA"); // Titulo y nombre del form
        }
