...
{
    public partial class mantenimiento_bono : Form
    {
        string usuario = "";        
        public mantenimiento_bono(String usuarioActivo)
        {
            InitializeComponent();
            usuario = usuarioActivo;
            string[] alias = { "Cod. Bono", "Membresia", "Monto", "Fecha", "Estado" }; // Arreglo de nombres para campos
            ...
            navegador1.asignarComboConTabla("cliente", "membresia", 0); // 0 o 1 en modo, 0 pone el id y 1 coloca el nombre y consulta el id
            navegador1.asignarTabla("BONO"); // tabla principal
            navegador1.asignarNombreForm("BONO"); // Titulo y nombre del form
        }
